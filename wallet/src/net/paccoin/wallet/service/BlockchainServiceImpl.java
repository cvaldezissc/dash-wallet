...
package net.paccoin.wallet.service;
...
import net.paccoin.wallet.service.BlockchainState.Impediment;
import net.paccoin.wallet.ui.WalletActivity;
import net.paccoin.wallet.util.BlockchainStateUtils;
import net.paccoin.wallet.util.CrashReporter;
import net.paccoin.wallet.util.ThrottlingWalletChangeListener;
    ...
    private final ThrottlingWalletChangeListener walletEventListener = new ThrottlingWalletChangeListener(
        ...
        public void onCoinsReceived(final Wallet wallet, final Transaction tx, final Coin prevBalance,
            ...
            if (tx.getExchangeRate() == null && ((!replaying || insideTxExchangeRateTimeThreshold) || tx.getConfidence().getConfidenceType() == ConfidenceType.PENDING)) {
                try {
                    final net.paccoin.wallet.rates.ExchangeRate exchangeRate = AppDatabase.getAppDatabase()
