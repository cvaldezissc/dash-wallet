...
import net.paccoin.wallet.ui.preference.PreferenceActivity;
import net.paccoin.wallet.ui.send.SendCoinsActivity;
import net.paccoin.wallet.ui.send.SweepWalletActivity;
import net.paccoin.wallet.ui.widget.UpgradeWalletDisclaimerDialog;
import net.paccoin.wallet.util.CrashReporter;
import net.paccoin.wallet.util.Crypto;
import net.paccoin.wallet.util.FingerprintHelper;
import net.paccoin.wallet.util.Io;
